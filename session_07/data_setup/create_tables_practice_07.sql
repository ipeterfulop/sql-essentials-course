CREATE SCHEMA IF NOT EXISTS practice_07;
SET SEARCH_PATH TO practice_07;

CREATE TABLE practice_07.business_units
(
...
CREATE TABLE practice_07.bands
(
    id           SERIAL PRIMARY KEY,
...
CREATE TABLE practice_07.job_titles
(
    id   SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL
);

CREATE TABLE practice_07.countries
(
...
CREATE TABLE practice_07.languages
(
...
CREATE TABLE practice_07.employees
(
    id                            SERIAL PRIMARY KEY,
...
CREATE TABLE practice_07.customers (
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
...
CREATE TABLE practice_07.projects (
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
...
CREATE TABLE practice_07.project_assignments (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE practice_07.leave_types
(
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL
);

CREATE TABLE practice_07.leave_request_statuses
(
    id SERIAL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
...
CREATE TABLE practice_07.leave_days
(
    id SERIAL PRIMARY KEY,
...
ALTER TABLE practice_07.annual_employee_awards
